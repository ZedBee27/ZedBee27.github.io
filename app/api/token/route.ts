...
if (!process.env.STREAM_SECRET_KEY) throw new Error(`STREAM_API_SECRET environment variable is not defined.`)

const client = connect(process.env.NEXT_PUBLIC_STREAM_API_KEY, process.env.STREAM_SECRET_KEY)
