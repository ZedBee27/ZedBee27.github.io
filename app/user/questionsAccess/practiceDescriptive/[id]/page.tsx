...
function DescriptiveQuestionPracticeForm({ params }: QuestionPracticeFormProps) {
  ...
  return (
    <>
      <div className="w-1/6">
        <BackButton text="Go Back" link={`/user/questionsAccess`} />
      </div>
      <div className="h-full flex justify-center bg-blue-50 dark:bg-slate-900 rounded-lg">
        <div>
          <h3 className="text-2xl text-center font-semibold font-serif mb-1 border-0 focus-visible:ring-0 text-black p-1 rounded dark:text-white focus-visible:ring-offset-0">
