...
const formSchema = z.object({
    ...
    option1: z.string().min(0, {
        message: 'Option is required',
    }),
    option2: z.string().min(0, {
        message: 'Option is required',
    }),
    option3: z.string().min(0, {
        message: 'Option is required',
    }),
    option4: z.string().min(0, {
        message: 'Option is required',
    }),
...
const QuestionCreatePage = () => {
    ...
    const handleSubmit = async (data: FormValues) => {
        try {
            ...
            toast({ title: 'Question has been created successfully' });
    ...
    return ( 
        <>
            <h3 className="text-2xl mb-4">Create Question</h3>
            <Form {...form}>
                                ...
                                <Select onValueChange={field.onChange} {...field}>
                                    <FormControl className='bg-slate-100 dark:bg-slate-500 border-0 focus-visible:ring-0 text-black dark:text-white focus-visible:ring-offset-0'>
                                        <SelectTrigger className='outline-none'>
                                            <SelectValue placeholder="Select Question Type" className='' />
                                        </SelectTrigger>
                                    </FormControl>
                                    <SelectContent>
