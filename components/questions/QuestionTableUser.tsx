...
const QuestionTableUser = ({ title, limit, paginate }: QuestionTableProps) => {
    ...
    const currentQuestions = limit ? questions.slice(0,limit) : questions.slice(firstQuestionIndex, lastQuestionIndex);
            ...
            <Table className="border-1 border-slate-200">
                <TableHeader>
                    <TableRow>
                        ...
                        <TableHead className="hidden lg:table-cell text-black dark:text-white">Topic</TableHead>
                        <TableHead className="hidden lg:table-cell text-black dark:text-white">Difficulty Level</TableHead>
                ...
                <TableBody>
                    {currentQuestions.map((question) => (
                        <TableRow key={question.id} className="odd:bg-blue-50 dark:odd:bg-slate-950">
                            ...
                            <TableCell className="hidden lg:table-cell dark:text-blue-600">{question.topic}</TableCell>
                            <TableCell className="hidden lg:table-cell dark:text-blue-600">{question.difficulty}</TableCell>
                            <TableCell className="flex flex-row dark:text-blue-600">
                                {question.type === 'MCQ' && (
                                    <Link href={`/user/questionsAccess/practiceMCQ/${question.id}`}>
                                        <Button
                                ...
                                {question.type === 'DESCRIPTIVE' && (
                                    <Link href={`/user/questionsAccess/practiceDescriptive/${question.id}`}>
                                        <Button
                                            onClick={() => analytics.track('Going to Practice Page', {
                                                question_id: question.id,
                                                question: question.question,
...
export default QuestionTableUser;