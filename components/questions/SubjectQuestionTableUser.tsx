...
const SubjectQuestionTableUser = ({ title, limit, subject }: QuestionTableProps) => {
    ...
    const filteredQuestions = questions.filter((question) => question.subject.toLowerCase() === subject?.toLowerCase());
                    ...
                    {currentQuestions.map((question) => (
                        <TableRow key={question.id} className="odd:bg-blue-50 dark:odd:bg-slate-950">
                            ...
                            <TableCell className="flex flex-row dark:text-blue-600">
                                {question.type === 'MCQ' && (
                                    <Link href={`/user/subjects/${subject}/practiceMCQ/${question.id}`}>
                                        <Button
                                ...
                                {question.type === 'DESCRIPTIVE' && (
                                    <Link href={`/user/subjects/${subject}/practiceDescriptive/${question.id}`}>
                                        <Button
                                            onClick={() => analytics.track('Going to Practice Page', {
                                                question_id: question.id,
                                                question: question.question,
...
export default SubjectQuestionTableUser;